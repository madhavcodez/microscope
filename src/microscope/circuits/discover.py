...
(RULES.md E4). Default behavior: bias-in-bios profession classification. Produce ONE clean, validated
circuit (not several partial ones) and save the graph artifact. Changing the circuit target is a
research-design Human-Decision Gate.
"""
