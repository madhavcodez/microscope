...
| Custom SAE SAEBench sparse probing (sparsify→sae_lens adapter, encode-verified) | **novel (honest negative):** 0.670 < Gemma Scope 0.767 **and** < its own residual baseline 0.688 (budget training) | `saebench-custom-sae-v2` |
