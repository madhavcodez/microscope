...
|---|---|---|
| **File-as-memory multi-agent loop** (orchestrator + coder/tester/quality-checker) | Subagents start fresh; durable state must be files. Forces honest logging. | CLAUDE.md |
...
Read CLAUDE.md → docs/RULES.md → docs/PROGRESS.md → ADRs 0001–0003 → this file → REPORT.md. The proven
